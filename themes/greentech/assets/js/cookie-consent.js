var CookieConsent = (function() {
  return {
    ...
    'accept': function() {
      ...
      document.cookie = CookieConsent.cookieName + "=1; path=/; SameSite=Strict; max-age=" + CookieConsent.cookieDurationInDays*24*60*60;
      CookieConsent._addAnalytics();
    },

    'reject': function() {
      CookieConsent._closeBanner();
      document.cookie = CookieConsent.cookieName + "=0; path=/; SameSite=Strict; max-age=" + CookieConsent.cookieDurationInDays*24*60*60;
    }
  }
